...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predictions, targets):
        ...
        pos_idx = pos.unsqueeze(pos.dim()).expand_as(loc_data) # Shape: [batch,num_priors,4]
